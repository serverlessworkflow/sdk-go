	...
	*out = *in
	...
	if in.Metadata != nil {
		...
		*out = new(Metadata)
		if **in != nil {
			in, out := *in, *out
			*out = make(map[string]SwObject, len(*in))
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *SwObject) DeepCopyInto(out *SwObject) {
	*out = *in
	if in.Object != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new SwObject.
func (in *SwObject) DeepCopy() *SwObject {
	if in == nil {
		return nil
	}
	out := new(SwObject)
