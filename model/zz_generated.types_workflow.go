...
func (j *Injectstate) UnmarshalJSON(b []byte) error {
	...
	type Plain Injectstate
	var plain Plain
	if err := json.Unmarshal(b, &plain); err != nil {
		return err
	}
	if v, ok := raw["usedForCompensation"]; !ok || v == nil {
		plain.UsedForCompensation = false
	}
	*j = Injectstate(plain)
	return nil
}
...
type End struct {
	// If set to true, triggers workflow compensation before workflow execution
...
// UnmarshalJSON implements json.Unmarshaler.
func (j *End) UnmarshalJSON(b []byte) error {
	var raw map[string]interface{}
	if err := json.Unmarshal(b, &raw); err != nil {
		return err
	}
	...
	if v, ok := raw["compensate"]; !ok || v == nil {
...
type Parallelstate struct {
	...
	// Unique Name of a workflow state which is responsible for compensation of this
	// state
...
type Databasedswitch struct {
	...
	// Databasedswitchcommon corresponds to the JSON schema field
	// "databasedswitchcommon".
	Databasedswitchcommon *Databasedswitchcommon `json:"databasedswitchcommon,omitempty"`
}
...
// UnmarshalJSON implements json.Unmarshaler.
func (j *Callbackstate) UnmarshalJSON(b []byte) error {
	var raw map[string]interface{}
	if err := json.Unmarshal(b, &raw); err != nil {
		return err
	}
	type Plain Callbackstate
	var plain Plain
	if err := json.Unmarshal(b, &plain); err != nil {
		return err
	}
...
// Contains most of the databasedswitch fields
...
// UnmarshalJSON implements json.Unmarshaler.
func (j *Delaystate) UnmarshalJSON(b []byte) error {
	var raw map[string]interface{}
	if err := json.Unmarshal(b, &raw); err != nil {
		return err
	}
	type Plain Delaystate
	var plain Plain
	if err := json.Unmarshal(b, &plain); err != nil {
		return err
	}
...
// UnmarshalJSON implements json.Unmarshaler.
func (j *Eventbasedswitchcommon) UnmarshalJSON(b []byte) error {
	var raw map[string]interface{}
	if err := json.Unmarshal(b, &raw); err != nil {
		return err
	}
	type Plain Eventbasedswitchcommon
	var plain Plain
	if err := json.Unmarshal(b, &plain); err != nil {
		return err
	}
	...
	*j = Eventbasedswitchcommon(plain)
	return nil
}
...
type Eventbasedswitch struct {
	...
	// Eventbasedswitchcommon corresponds to the JSON schema field
	// "eventbasedswitchcommon".
	Eventbasedswitchcommon *Eventbasedswitchcommon `json:"eventbasedswitchcommon,omitempty"`
}
...
type Eventbasedswitchcommon struct {
	// Unique Name of a workflow state which is responsible for compensation of this
	// state
	CompensatedBy *string `json:"compensatedBy,omitempty"`
...
type Transition struct {
	// If set to true, triggers workflow compensation when before this transition is
