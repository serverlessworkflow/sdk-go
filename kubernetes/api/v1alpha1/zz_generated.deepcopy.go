...
func (in *ServerlessWorkflowList) DeepCopyInto(out *ServerlessWorkflowList) {
	*out = *in
	...
	if in.Items != nil {
		...
		*out = make([]ServerlessWorkflow, len(*in))
		for i := range *in {
...
func (in *ServerlessWorkflowList) DeepCopy() *ServerlessWorkflowList {
	if in == nil {
		return nil
	}
	out := new(ServerlessWorkflowList)
	in.DeepCopyInto(out)
	return out
}
...
func (in *ServerlessWorkflowSpec) DeepCopy() *ServerlessWorkflowSpec {
	if in == nil {
		return nil
	}
	out := new(ServerlessWorkflowSpec)
	in.DeepCopyInto(out)
	return out
}
...
func (in *ServerlessWorkflowStatus) DeepCopy() *ServerlessWorkflowStatus {
	if in == nil {
		return nil
	}
	out := new(ServerlessWorkflowStatus)
	in.DeepCopyInto(out)
	return out
}
